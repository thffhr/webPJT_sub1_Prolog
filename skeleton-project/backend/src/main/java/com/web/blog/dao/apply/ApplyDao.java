...
public interface ApplyDao extends JpaRepository<Apply, Integer> {
    ...
    //as temp where temp.uid = :uid and temp.ap_term = :period and temp.ap_company = :searchtxt
    ...
    List<Apply> findListBySearch(@Param("uid") String uid, @Param("searchTxt") String searchTxt, @Param("period") String period);
